...
#include <GL/glu.h>
#include <GL/glut.h>
			//typedef GLbyte					__char;
			typedef char                    __char;
			typedef GLshort					__sword;
			typedef GLint					__sdword;
			typedef long long               __sqword;
			typedef GLubyte                 __byte;
			typedef GLushort		        __word;
			typedef GLuint                  __dword;
			typedef unsigned long long		__qword;
			typedef GLfloat					__float;
			typedef GLdouble				__double;
			typedef GLboolean				__bool;
#endif
